 ...
 */
class AnimeListAdapter(private var context: Context, private var items: MutableList<AnimeListModel>) : RecyclerView.Adapter<AnimeListAdapter.AnimeListAdapterViewHolder>() {
    ...
    class AnimeListAdapterViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val description: TextView = view.find(R.id.anime_newest_episode)
